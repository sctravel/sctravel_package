var OpinionLab = (function(){
	var custom_var,_sp='_.html\\/\\/',_rp='_/index.html',_poE=0.0,_poX=0.0,_sH=screen.height,_d=document,_w=window,_ht=escape(_w.location.href),_hr=_d.referrer,_tm=(new Date()).getTime(),_kp=0,_sW=screen.width;
	...
	function _replacePageName(){
		...
		if(page_name){
			_domain=_ht.replace('https_/index.html', '').replace('http_/index.html','');
			_ht=_ht.substr(0,_ht.indexOf('_/index.html'))+'%3A//'+_domain.substr(0,_domain.indexOf('index.html'))+'\/'+page_name;	
